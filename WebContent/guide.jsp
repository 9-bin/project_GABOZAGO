    ...
    <div class="view" style=" width: 100vw; height: 100vh; background-color: yellow;">
        ...
        <div class="left" style="float: left; width: 30%; height: 100vh;background-color: lightslategray;">
         <!-- 로그인부분 -->
            ...
            <!-- 가이드 리스트 -->
            <div style="float: left; width: 100%; height: 40px;background-color:lightslategray; margin: 20px;">
            ...
            <!-- 아래 남는 부분 -->
            <div style="float: left; width: 100%; height: 395px;background-color:lightslategray;"></div>
