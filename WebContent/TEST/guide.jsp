...
<div style=" width: 100%; height: 650px; background-color: yellow;">
    ...
    background-color: lightslategray;">
        ...
        <form action="login.do" method="post">
            <table style=" margin:auto; " >
                <tr>
                    <td><input type="submit" value="내일정표" style="font-size: 20px; text-align: center;"></td>
                </tr>
                <tr>
                    <td><input type="submit" value="가이드" style="font-size: 20px; text-align: right: ;"></td>
                    <td><input type="submit" value="교통" style="font-size: 20px; text-align: left: ;"></td>
                </tr>
            </table>
    ...
    <!-- appkey=3d7d3428f35bb9a9deb43f36f2716406 -->
        <div id="mapwrap"> 
		    <!-- 지도가 표시될 div -->
